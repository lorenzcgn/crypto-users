...
<body>
	...
	<section class="page-info-section">
		<div class="container">
			...
			<div class="site-beradcamb">
				<a href="">Home</a>
				<span><i class="fa fa-angle-right"></i> Withdraw your money</span>
			</div>
		</div>
	</section>
	<!-- Page info end -->
	...
	<section class="about-section spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-6 about-text">
					<h5>Follow the instructions to withdraw your money.</h5>
		...
		Select portfoliocode (or withdraw cryptos from all wallets with or without a specific purpose):
		<br>
...
?>
		...
		Select purpose of your wallets (or withdraw cryptos from wallets with a specific portfoliocode):
		<select name="purpose">
...
?>
        ...
        <input class="site-btn sb-gradients sbg-line mt-5" type="submit" value= "Withdraw from your wallet">
      </form><br><br>
                    </div>
