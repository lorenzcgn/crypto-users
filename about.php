...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-6 about-text">
					...
					<a href="index.php" class="site-btn sb-gradients sbg-line mt-5">Get Started</a>
				</div>
			</div>
			<div class="about-img">
	...
	<section class="team-section spad">
		...
		<div class="team-members center clearfix">
			<!-- Team member -->
			<div class="member center">
				<div class="member-text">
					<div class="member-img set-bg" data-setbg="img/member/6.jpg"></div>
					<h2>Cagni Lorenzo</h2>
					<span>CEO</span>
				</div>
				...
				<div class="member-info">
					<div class="member-img mf set-bg" data-setbg="img/member/6.jpg"></div>
					<div class="member-meta">
						<h2>Cagni Lorenzo</h2>
						<span>CEO</span>
					</div>
					<p>Lorenzo Cagni is a student of I.I.S. Castelli in Brescia and he created this website.</p>
				</div>
			</div>
				...
				<div class="col-lg-4 pr-0 pull-3">
					<div class="review-meta-slider owl-carousel pt-5">
						<div class="author-meta">
							<div class="author-avatar set-bg" data-setbg="img/member/6.jpg"></div>
