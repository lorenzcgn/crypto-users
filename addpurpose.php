	...
	<section class="about-section spad">
		<div class="container">
			<div class="container-fluid">
				<h2>All your purposes</h2>
				<br>
				  <div class="row align-items-start">

	
				<div class="col-8">
					<h5>Follow the instructions to add a new purpose.</h5>
					
                    
                    
                    
                    <form action="insertpurpose.php" method="GET"><br>
		Insert name: 
        <input type="text" name="purposename">
		<hr>
		Insert description: 
        <input type="text" name="purposedescription"><br>
		
		
        <input class="site-btn sb-gradients sbg-line mt-5" type="submit" value= "Add purpose">
      </form>
			<br>
